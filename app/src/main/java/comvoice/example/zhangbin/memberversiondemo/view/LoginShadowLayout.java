...
public class LoginShadowLayout extends FrameLayout {
    ...
    public LoginShadowLayout(final Context context) {
        this(context, null);
    }

    public LoginShadowLayout(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LoginShadowLayout(final Context context, final AttributeSet attrs, final int defStyleAttr) {
