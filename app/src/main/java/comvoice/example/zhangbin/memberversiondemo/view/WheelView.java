...
public class WheelView extends ScrollView {
    ...
    private List<String> items = new ArrayList<>();//所有选项
    ...
    public final void setItems(List<?> items) {
        ...
        for (Object item : items) {
            if (item instanceof String) {
                ...
                throw new IllegalArgumentException("please implements " + String.class.getName());
            }
        }
        remeasure();
        invalidate();
        ...
        postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (onWheelListener != null) {
                    onWheelListener.onSelected(true, selectedIndex, items.get(selectedIndex));
                }
            }
        }, 200L);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < visibleItemCount) {
            ...
            if (isLoop) {
                ...
                visibleItemStrings[counter] = items.get(index);
            } else if (index < 0) {
